...
def test_clique_merge1():
    ...
    g1.add_edge('ENSEMBL:4', 'HGNC:1', key=generate_edge_key('ENSEMBL:4', 'biolink:same_as', 'HGNC:1'), **{'edge_label': 'biolink:same_as', 'relation': 'owl:equivalentClass'})
    g1.add_edge('NCBIGene:3', 'HGNC:1', key=generate_edge_key('NCBIGene:3', 'biolink:same_as', 'HGNC:1'), **{'edge_label': 'biolink:same_as', 'relation': 'owl:equivalentClass'})
    g1.add_edge('OMIM:2', 'HGNC:1', key=generate_edge_key('OMIM:2', 'biolink:same_as', 'HGNC:1'), **{'edge_label': 'biolink:same_as', 'relation': 'owl:equivalentClass'})

    g1.add_edge('ENSEMBL:6', 'NCBIGene:8', key=generate_edge_key('ENSEMBL:6', 'biolink:same_as', 'NCBIGene:8'), **{'edge_label': 'biolink:same_as', 'relation': 'owl:equivalentClass'})
    g1.add_edge('HGNC:7', 'NCBIGene:8', key=generate_edge_key('HGNC:7', 'biolink:same_as', 'NCBIGene:8'), **{'edge_label': 'biolink:same_as', 'relation': 'owl:equivalentClass'})
...
def test_clique_merge2():
    ...
    g1.add_edge('ENSEMBL:4', 'HGNC:1', key=generate_edge_key('ENSEMBL:4', 'biolink:same_as', 'HGNC:1'),
                **{'edge_label': 'biolink:same_as', 'relation': 'owl:equivalentClass'})
    g1.add_edge('NCBIGene:3', 'HGNC:1', key=generate_edge_key('NCBIGene:3', 'biolink:same_as', 'HGNC:1'),
                **{'edge_label': 'biolink:same_as', 'relation': 'owl:equivalentClass'})
    g1.add_edge('OMIM:2', 'HGNC:1', key=generate_edge_key('OMIM:2', 'biolink:same_as', 'HGNC:1'),
                **{'edge_label': 'biolink:same_as', 'relation': 'owl:equivalentClass'})

    g1.add_edge('ENSEMBL:6', 'NCBIGene:8', key=generate_edge_key('ENSEMBL:6', 'biolink:same_as', 'NCBIGene:8'),
                **{'edge_label': 'biolink:same_as', 'relation': 'owl:equivalentClass'})
    g1.add_edge('HGNC:7', 'NCBIGene:8', key=generate_edge_key('HGNC:7', 'biolink:same_as', 'NCBIGene:8'),
                **{'edge_label': 'biolink:same_as', 'relation': 'owl:equivalentClass'})
...
def test_clique_merge9():
    ...
    g1.add_edge('X:00001', 'OMIM:2', key=generate_edge_key('X:00001', 'biolink:same_as', 'OMIM:2'),
                **{'edge_label': 'biolink:same_as', 'relation': 'owl:equivalentClass'})
    g1.add_edge('NCBIGene:3', 'HGNC:1', key=generate_edge_key('NCBIGene:3', 'biolink:same_as', 'HGNC:1'),
                **{'edge_label': 'biolink:same_as', 'relation': 'owl:equivalentClass'})
