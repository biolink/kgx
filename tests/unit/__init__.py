...
def get_graph(source):
    ...
    g2 = NxGraph()
    g2.add_node('A', **{'id': 'A', 'category': ['biolink:NamedThing'], 'source': source})
    g2.add_node('B', **{'id': 'B', 'category': ['biolink:NamedThing'], 'source': source})
    g2.add_node('C', **{'id': 'C', 'category': ['biolink:NamedThing'], 'source': source})
    g2.add_node('D', **{'id': 'D', 'category': ['biolink:NamedThing'], 'source': source})
    g2.add_node('E', **{'id': 'E', 'category': ['biolink:NamedThing'], 'source': source})
    g2.add_node('F', **{'id': 'F', 'category': ['biolink:NamedThing'], 'source': source})
