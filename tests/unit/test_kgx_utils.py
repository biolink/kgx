...
from kgx.utils.kgx_utils import get_toolkit, get_curie_lookup_service, get_prefix_prioritization_map, \
    ...
    sanitize_import, _build_export_row, _sanitize_import, _sanitize_export, validate_node, DEFAULT_NODE_CATEGORY, \
    validate_edge
...
@pytest.mark.parametrize('query', [
    ...
    ({'id': 'A', 'name': 'Node A', 'description': None, 'property': [pd.NA, 123, 'ABC'], 'score': 0.0}, {'id': 'A', 'name': 'Node A', 'property': [123, 'ABC'], 'score': 0.0})
])
