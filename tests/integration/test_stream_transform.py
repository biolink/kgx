...
@pytest.mark.parametrize('query', [
    ...
    (
        ...
        {
            'filename': os.path.join(TARGET_DIR, 'graph6'),
            'format': 'jsonl'
        },
        133,
        13
...
@pytest.mark.parametrize('query', [
    ...
    (
        ...
        {
            'filename': os.path.join(TARGET_DIR, 'graph2s2'),
            'format': 'jsonl'
        },
        512,
        532
    ...
    (
        ...
        {
            'filename': os.path.join(TARGET_DIR, 'graph3s2.nt'),
            'format': 'nt'
        },
        512,
        532
    ...
    (
        ...
        {
            'filename': os.path.join(TARGET_DIR, 'graph4s2'),
            'format': 'jsonl'
        },
        133,
        13
...
@pytest.mark.parametrize('query', [
    (
        ...
        },
        {
            ...
            'edge_properties': ['subject', 'predicate', 'object', 'relation', 'category', 'fusion', 'homology',
                                'combined_score', 'cooccurrence'],
        },
        7,
        6
    ),
    (
        ...
        {
            'filename': os.path.join(TARGET_DIR, 'graph2s3.json'),
            'format': 'json'
        },
        7,
        6
    ...
    (
        ...
        {
            'filename': os.path.join(TARGET_DIR, 'graph3s3'),
            'format': 'jsonl'
        },
        7,
        6
    ...
    (
        ...
        {
            'filename': os.path.join(TARGET_DIR, 'graph4s3'),
            'format': 'jsonl'
        },
        6,
        3
...
@pytest.mark.parametrize('query', [
    ...
    (
        ...
        {
            'filename': os.path.join(TARGET_DIR, 'graph4s4'),
            'format': 'jsonl'
        },
        72,
        73
...
@pytest.mark.parametrize('query', [
    ...
    (
        ...
        {
            'filename': os.path.join(TARGET_DIR, 'graph2s5'),
            'format': 'jsonl'
        },
        220,
        1050
    ...
    (
        ...
        {
            'filename': os.path.join(TARGET_DIR, 'graph3s5.nt'),
            'format': 'nt'
        },
        220,
        1050
...
@pytest.mark.parametrize('query', [
    ...
    (
        ...
        {
            'filename': os.path.join(TARGET_DIR, 'graph5s6'),
            'format': 'jsonl'
        },
        2,
        0
