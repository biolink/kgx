...
**_Note:_** Support for release 4.3 of Neo4j is pending in the next KGX release (see the 
[neo4j-client-upgrade](https://github.com/biolink/kgx/tree/neo4j-client-upgrade]) for the beta release of this code).
